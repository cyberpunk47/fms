                                    ...
                                    <?php foreach ($evaluations as $eval): ?>
                                        <div class="border border-gray-200 rounded-md p-4">
                                            ...
                                            <p class="text-sm text-gray-600 mt-2">
                                                Evaluator: <?php echo htmlspecialchars($eval['evaluator_name']); ?>
                                            </p>
                                            <?php if (!empty($eval['overall_score'])): ?>
                                                <div class="mt-2 flex items-center">
                                                    <div class="text-sm font-medium text-gray-900">Score: </div>
                                                    <div class="ml-2 text-sm text-gray-700"><?php echo number_format($eval['overall_score'], 2); ?>/5.00</div>
                                                </div>
                                            <?php endif; ?>
                                            <div class="mt-3">
