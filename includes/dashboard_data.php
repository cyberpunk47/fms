...
// Only include these functions if not already defined
if (!function_exists('getDashboardStatsAlt')) {
    function getDashboardStatsAlt() {
        ...
        try {
            ...
            // If tables exist, get other stats
...
if (!function_exists('getRecentActivity')) {
    function getRecentActivity($limit = 5) {
        ...
        try {
            ...
            // Prepare queries for each type of activity
            $queries = [];
            ...
            // If queries fail or no tables exist, return sample data
            return getSampleActivities();
